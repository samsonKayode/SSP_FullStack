...
public class UserAuthenticationProvider {
    ...
    private static List<SimpleGrantedAuthority> authorityList = EnumSet.allOf(RoleTypes.class).stream().map(
            e -> new SimpleGrantedAuthority(e.name())).collect(Collectors.toList());
